...
export class NotificationExceptionFormComponent implements OnInit {
  submitting = false;
  ...
  constructor(
    ...
    this.notificationNameFormControl = new FormControl(data.notificationName, [
      Validators.required,
    ]);
  ...
  onSubmit() {
    let exception = new NotificationException();
